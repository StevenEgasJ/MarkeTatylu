...
router.get('/orders', async (req, res) => {
  ...
  try {
    ...
    const out = orders.map(o => ({ id: o._id, userId: o.userId, userEmail: usersById[String(o.userId)] ? usersById[String(o.userId)].email : null, resumen: o.resumen, items: o.items, estado: o.estado, fecha: o.fecha }));
